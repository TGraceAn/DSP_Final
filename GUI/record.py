...
background = tk.PhotoImage(file="DSP_Final/GUI/dsp_img/background_1_img.png")
label_background = tk.Label(root, image = background)
label_background.pack()


record_img = tk.PhotoImage(file="DSP_Final/GUI/dsp_img/button/record_icon.png")
stop_record_img = tk.PhotoImage(file="DSP_Final/GUI/dsp_img/button/stop_record_icon.png")
out_img = tk.PhotoImage(file="DSP_Final/GUI/dsp_img/button/out_icon.png")
# ----------------------------------------------------------------------------
